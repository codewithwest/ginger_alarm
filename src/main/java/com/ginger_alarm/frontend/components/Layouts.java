...
import com.ginger_alarm.backend.DBManager;
import com.ginger_alarm.backend.DayToDate;
    ...
    public VBox newAlarmLayout() {
        ...
        addNewAlarmButton.setOnAction(e->{
            ...
            DbManager.AlarmUpdate("new",alarmMessageInput.getText(),
                    ...
                    ResolvedDays);
            String compiledAlarmData = "{" + alarmMes + chosenTime + repeatedTime + ResolvedDays + "}";
